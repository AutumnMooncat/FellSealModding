...
namespace XPOverflow
{
    ...
    public class Patches
    {
        ...
        private static readonly Context<Inventory> AddMissionRewardCtx = 
            ContextTools.RequestContext<Inventory>(
                nameof(Inventory.AddMissionReward), 
                typeof(Inventory.MissionInProgress), typeof(MissionListBox.MissionRewardResult), typeof(Missions.MissionResult)
            );

        private static readonly Context<BaseCharacter> LevelUpCtx = 
            ContextTools.RequestLateContext<BaseCharacter>(nameof(BaseCharacter.LevelUp));

        private static readonly Context<DamageCalculations> CalculateExpGainCtx =
            ContextTools.RequestLateContext<DamageCalculations>(
                nameof(DamageCalculations.CalculateExpGain), 
                typeof(BattleCharacter), typeof(List<BattleCharacter>), typeof(DamageCalculations.DamageResult), typeof(SpellEffect.ForceExp)
            );
